  ...
  <div class="play">
    ...
    <div :style="{backgroundColor: skinColor}" class="header">
      ...
      <div @click="isShowMusicList=false" class="title">
        <div class="name">{{audio.name || (musicData[0]&&musicData[0].name) || 'Powered by jiyangaigou.com'}}</div>
      </div>
    ...
    <div class="content">
      ...
      <img @click.stop.prevent="isShowSkinColors=false;isShowMusicList=false" :src="audio.musicImgSrc || (musicData[0]&&musicData[0].musicImgSrc) || defaultImg" alt="jiyangaigou.com">
      <div @click.stop.prevent="isShowSkinColors=false;isShowMusicList=false" class="img">
        <img :src="audio.musicImgSrc || (musicData[0]&&musicData[0].musicImgSrc) || defaultImg" alt="jiyangaigou.com">
      </div>
      <div class="progress">
...
export default {
  ...
  data() {
    return {
      defaultImg: 'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1494264631469&di=953664464e210a6c8d8b40de58c28279&imgtype=0&src=http%3A%2F%2Fimg5q.duitang.com%2Fuploads%2Fitem%2F201502%2F22%2F20150222165859_BvdtT.jpeg',
  ...
  methods: {
    back() {
      ...
      /*如果路由是MV或者是 则要停止播放音乐和不显示音乐*/
      if (this.$route.name == 'MV' || this.$route.name == 'MvList') {
